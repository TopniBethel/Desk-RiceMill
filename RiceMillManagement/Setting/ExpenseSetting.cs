...
{
    public partial class ExpenseSetting : Form
    {
        private string login;
        public ExpenseSetting(string login)
        {
        ...
        void grid()
        {
            try
            {
                ...
                adb = new SqlDataAdapter("select id as Id,name as Name from ExpenseSetting_tbl order by id asc", Database.con);
        ...
        private void Save_btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string qry1 = "select * from ExpenseSetting_tbl where name='" + Name_txt.Text + "'";
                    ...
                    {
                        string qry = "insert into ExpenseSetting_tbl values('" + Name_txt.Text + "')";
                        SqlCommand cmd = new SqlCommand(qry, Database.con);
                        cmd.ExecuteNonQuery();

                        string qry3 = "insert into LogReport_tbl values('" + login + "','" + DateTime.Now + "','ExpenseSetting','Expense:" + Name_txt.Text + "_Insert','" + DateTime.Now.ToString("yyyy-MM-dd") + "')";
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        string qry = "delete from ExpenseSetting_tbl where id=" + getid + "";
                        SqlCommand cmd = new SqlCommand(qry, Database.con);
                        cmd.ExecuteNonQuery();

                        string qry3 = "insert into LogReport_tbl values('" + login + "','" + DateTime.Now + "','ExpenseSetting','Expense:" + getid + "_Delete','" + DateTime.Now.ToString("yyyy-MM-dd") + "')";
                        SqlCommand cmd3 = new SqlCommand(qry3, Database.con);
                        cmd3.ExecuteNonQuery();
        ...
        private void Update_btn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string qry3 = "insert into LogReport_tbl values('" + login + "','" + DateTime.Now + "','ExpenseSetting','Expense Update','" + DateTime.Now.ToString("yyyy-MM-dd") + "')";
                SqlCommand cmd3 = new SqlCommand(qry3, Database.con);
                cmd3.ExecuteNonQuery();
            }
            catch (Exception ex)
        ...
        private void ExpenseSetting_Load(object sender, EventArgs e)
        {
            Name_txt.Focus();
        }
