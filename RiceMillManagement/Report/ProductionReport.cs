...
namespace RiceMillManagement.Report
{
    public partial class ProductionReport : Form
    {
        ...
        public ProductionReport(string login)
        {
        ...
        private void Search_btn_Click(object sender, EventArgs e)
        {
            ...
            string qry = "select id as Id,orderno as SNo,stockfor as StockFor,productionid as Production,grade as Grade,bag as Bag,name as Name,total as Total,date as Date from ProductionEntry_tbl where date between '" + Convert.ToDateTime(dateTimePicker1.Text).ToString("yyyy-MM-dd") + "' and '" + Convert.ToDateTime(dateTimePicker2.Text).ToString("yyyy-MM-dd") + "' order by id desc";
